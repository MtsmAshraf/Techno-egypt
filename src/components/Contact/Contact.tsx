        ...
        <div className="container">
          <div className={styles.info}>
              ...
              <div>
                <div>
                  <div>
                    <a target='_blank' className={styles.iconLink + ` hexagon`} href="mailto:islam.mahrous@icsf-eg.com?subject=Email-from-ICSF-website">
                ...
                <h3>
                  Email
                    ...
                    <div>
                      <a target='_blank' href="mailto:islam.mahrous@icsf-eg.com?subject=Email-from-ICSF-website">
                        islam.mahrous@icsf-eg.com
                      </a>
                    </div>
                  </div>  
                </div>
              ...
              <div>
                ...
                <div>
                  <div>
                    <a target='_blank' className={styles.iconLink + ` hexagon`} href="mailto:moaz.mahrous@icsf-eg.com?subject=Email-from-ICSF-website">
                      <FontAwesomeIcon icon={faEnvelope} />
                    </a>
                <h3>
                  Email
                    ...
                    <div>
                      <a target='_blank' href="mailto:moaz.mahrous@icsf-eg.com?subject=Email-from-ICSF-website">
                        moaz.mahrous@icsf-eg.com
                      </a>
                    </div>
                  </div>  
                </div>
          ...
          <div className={styles.socialMedia}>
                <a href="https://www.facebook.com/profile.php?id=100064239420433" target='_blank'>
